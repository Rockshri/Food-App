...
describe("Contact us page test cases", ()=>{
      ...
      //if u want do do something before all test get executes, then there is a function named
       beforeAll(()=>{
        console.log("Before all test case");
    });

      //if u want to run something before each test case executes
       beforeEach(()=>{
    ...
    //if u want to run anything after running or completing all tests
     ...
     // if you want to run anything after running each test case
       afterEach(()=>{
     ...
     //Instead of using *test* we can write *it* also. It is just alias of *test* keyword.
